...
const Hero = () => {
  ...
  return (
    <div className="h-screen py-4 px-6 lg:flex">
      <div className="lg:flex lg:flex-row-reverse items-center justify-center bg-primary/5 w-full">
        <motion.div
        ...
        <motion.div
          ...
          className="flex flex-col items-center justify-center text-center lg:w-[50%]"
        >
          ...
          <p className="text-center lg:text-xl">
            Elevate Your Growth. Drive Impact. Partner with HIRCTF for expert
