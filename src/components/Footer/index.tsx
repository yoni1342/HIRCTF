    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        ...
        >
          ...
          <span className="link link-hover">Consultancy</span>
          <span className="link link-hover">Research</span>
          <span className="link link-hover">Training</span>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        ...
        >
          ...
          <p>
            HORN INTERNATIONAL RESEARCH, CONSULTANCY AND TRAINING FIRM (HIRCTF)
          </p>
        </motion.div>
        <motion.div
          variants={animation.card}
